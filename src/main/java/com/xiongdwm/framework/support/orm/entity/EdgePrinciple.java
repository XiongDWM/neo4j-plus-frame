package com.xiongdwm.framework.support.orm.entity;
...
import com.xiongdwm.framework.support.orm.helper.exception.Neo4jPrincipleException;
...
public class EdgePrinciple extends DynamicPrinciple {
    ...
    private AbstractCypherHelper.RelationshipDirection direction= AbstractCypherHelper.RelationshipDirection.UNDIRECTED;
    ...
    public EdgePrinciple clear(){
        ...
        this.direction= AbstractCypherHelper.RelationshipDirection.UNDIRECTED;
        return this;
    }
    ...
    public AbstractCypherHelper.RelationshipDirection getDirection() {
        return direction;
    }

    public void setDirection(AbstractCypherHelper.RelationshipDirection direction) {
    ...
    public static void main(String[] args) {
        EdgePrinciple edgePrinciple = new EdgePrinciple(R.class, P.class);
